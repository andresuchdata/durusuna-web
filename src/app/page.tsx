...
function ParentDashboard() {
  return (
    <div className="mx-auto w-full max-w-4xl space-y-4">
      ...
      <div className="rounded-2xl border border-dashed border-slate-200 bg-white/80 p-6 text-sm text-muted-foreground">
        Parent-focused widgets are coming soon.
      </div>
    </div>
  );
}
...
function StudentDashboard() {
  return (
    <div className="mx-auto w-full max-w-4xl space-y-4">
      ...
      <div className="rounded-2xl border border-dashed border-slate-200 bg-white/80 p-6 text-sm text-muted-foreground">
        Student progress widgets are coming soon.
      </div>
    </div>
  );
}
