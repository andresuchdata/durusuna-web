...
import { AlertCircle, BookOpen, CalendarDays, ChevronLeft, ChevronRight, Clock3, GraduationCap } from "lucide-react";
        ...
        <div className="mx-auto max-w-xl px-4 py-12">
          <Card className="p-6">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <h1 className="text-lg font-semibold">Student lessons only</h1>
              <p className="text-sm text-muted-foreground">This page is only available for student accounts.</p>
            </div>
          </Card>
        </div>
      </AppLayout>
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-6 md:py-8 space-y-6">
          <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-medium uppercase tracking-wide text-indigo-600">Student · Lessons</p>
                <h1 className="text-2xl font-semibold text-slate-900">Your lesson schedule</h1>
                <p className="text-xs text-muted-foreground">Pick a class and day, then filter by lesson status.</p>
              </div>
            </div>
